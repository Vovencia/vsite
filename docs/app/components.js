        ...
        return (React.createElement("div", tslib_1.__assign({}, _utils_1.attrs(this.props)),
            React.createElement(Content, null,
                React.createElement(ScrolledContent_1.default, null, this.props.apps.map((function (app) {
                    ...
                    return (React.createElement(Item, { typeShutcut: app.typeShutcut, onClick: this.handlerItemClick.bind(this, app), title: app.appInfo.name, key: app.id },
...
var Window = /** @class */ (function (_super) {
    ...
    Window.prototype.onBorderMove = function (mousePosition) {
        ...
        var minSize = _utils_1.sizeToPosition(this.getMinSize());
        ;
...
var WindowRender = /** @class */ (function (_super) {
    ...
    WindowRender.prototype.render = function () {
        ...
        return (React.createElement(Box, { style: style, elementRef: this.boxRef, isVisible: index_1.isVisible(this.props), inFocus: this.props.inFocus, className: this.props.className, onMouseDown: this.handlerOnPress.bind(this) },
            this.props.resizable && _utils_1.mapToArray(interfaces_1.windowBorderTypes, function (type, index) {
...
exports.actions = {
    ...
    open: function (props) {
        var options = tslib_1.__assign({}, Window_1.defaultWindowProps, { id: _utils_1.uid() }, props.options);
...
var WindowsManager = /** @class */ (function (_super) {
    ...
    WindowsManager.prototype.renderWindow = function (window) {
        return (React.createElement(Window_1.default, tslib_1.__assign({ key: window.id }, tslib_1.__assign({}, window, _utils_1.getWindowContent(window)))));
    };
...
var index_1 = __webpack_require__(/*! @components/Window/index */ "./components/Window/index.tsx");
var _utils_1 = __webpack_require__(/*! @utils */ "./utils/index.tsx");
...
function reducer(state, action) {
    ...
    switch (type) {
        case 'open':
            ...
            break;
        case 'load':
            state = _utils_1.stateLoad("WindowsManager", {
                opened: []
            });
            break;
        case 'focus':
    ...
    _utils_1.stateSave("WindowsManager", state);
    return state;
}
exports.reducer = reducer;
